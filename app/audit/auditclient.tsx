...
export default function AuditPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── MAIN GRID ── */}
      <div
        style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 0 }}
      >
        {/* ── FORM ── */}
        <div
          style={{
        ...
        >
          <div style={{ marginBottom: "28px" }}>
            ...
            <p style={{ fontSize: "12px", color: "#888780", lineHeight: 1.6 }}>
              Takes about 3 minutes. The more detail you share, the more useful
              your audit report will be.
            </p>
          </div>
          ...
          >
            ...
            <div>
              <label style={labelStyle}>
                Company / store name <span style={{ color: "#2D6A4F" }}>*</span>
              </label>
              <input
                style={inputStyle}
                type="text"
          ...
          >
            ...
            <div>
              <label style={labelStyle}>
                Approx. catalog size <span style={{ color: "#2D6A4F" }}>*</span>
              </label>
              ...
              {platforms.map((p) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "8px 10px",
                    fontSize: "12px",
                    color: selected.includes(p) ? "#2D6A4F" : "#555550",
                    background: selected.includes(p) ? "#E8F5EE" : "#FDFAF5",
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <textarea
              ...
              placeholder="e.g. Inaccurate attributes, duplicate listings, slow upload process, poor search visibility on Amazon..."
            />
          </div>
          <div
            style={{
